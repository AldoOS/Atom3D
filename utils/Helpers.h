...
//  OpenglESLibrary
//
//  Created by harald bregu on 26/02/14.
//  Copyright (c) 2014 harald bregu. All rights reserved.
//

#ifndef OpenglESLibrary_Helpers_h
#define OpenglESLibrary_Helpers_h
...
{
    public : static void SplitFileName(const string& str, string &folder, string &file)
    {
        size_t found;
